...
async function getAccessToken() {
  ...
  if(!accessToken) {
    ...
    if(!code) {
      window.location.href = 'https://secure.meetup.com/oauth2/authorize?client_id=hi1r286u66ertam55qqihmjp1b&response_type=code&redirect_uri=https://james-coates.co.uk/';
      return null;
    }
